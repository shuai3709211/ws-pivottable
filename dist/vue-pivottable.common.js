...
function makeRenderer() {
  ...
  var TableRenderer = {
    ...
    render: function render(h) {
      ...
      var pivotData = new utils_PivotData(this.$props);
...
var TSVExportRenderer = {
  ...
  render: function render(h) {
    ...
    return h('textarea', {
      style: {
        width: "100%",
        height: "".concat(window.innerHeight / 2, "px")
      },
      attrs: {
        readOnly: true
      },
...
/* harmony default export */ var Pivottable = ({
  ...
  methods: {
    ...
    createWrapperContainer: function createWrapperContainer(h) {
      return h('div', {
        style: {
          display: 'block',
          // width: '100%',
          'overflow-x': 'auto',
          'max-width': "".concat(this.tableMaxWidth, "px")
        }
